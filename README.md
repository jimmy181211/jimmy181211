...
I am interested in how intelligent systems interact with people and the physical world. Through coursework, research, and product development, I use software to turn these questions into practical projects and prototypes.
...
An approval-first AI companion for reviewing and drafting online replies, with risk classification, cloud/local data storage, and human approval before content is sent or posted. Planning experiments to evaluate the product's ideas and effects.
...
An interactive Python/Tkinter tool for visualizing core data structures, including stacks, queues, linked-lists, hash maps, max/min-heaps, red-black trees, and AVL trees.
